...
<section class="ftco-section">
   <div class="container">
    ...
    <c:forEach items="${voyages_acc}" var="q">
    
       <div class="col-md-4 ftco-animate">
          <div class="project-wrap">
          
        <a href="#" class="img"  style="background-image: url(data:image/jpg;base64);"> 
       <img src="data:image/jpg;base64,${q.getBase64Image()}" width="300" height="300" />${q.getImage_acc()}
                <span class="price">$ ${q.getPrix_acc()}/person</span>
            </a>
            <div class="text p-4">
                <span class="days">${q.getDuree_acc()} Days Tour</span>
                <h3 class="product-name">${q.getDestination_acc()}</h3>
                
                
                <p class="location"><span class="fa fa-map-marker"></span> ${q.getDestination_acc()}, ${q.getContinent_acc()}</p>
               Depart le  ${q.getDate_acc()}
                <ul>
                   
                   <li><span class="flaticon-mountains"></span>${q.getType_acc()}</li>
                   <li>Voyage ${q.getTheme_acc()}</li>
               </ul>
               
               <p class="location"><span class="fa fa-map-marker"></span> ${q.getActivite()}, ${q.getGenre()}</p>
              Guide : ${q.getGuide()}
...
<a  class="add-to-cart-btn"  href="detailsVAcc.php?id_c=${ q.getId_Voyage_acc() }" >Plus d'Info </a>
</div>
           </div>
       </div>
   </div>
