...
<!-- Cart -->
<a href="/pacific-main/login_client.jsp">
...
<a href="/pacific-main/panier?id_u=${idUtilisateur}">
...
<section class="ftco-section">
   <div class="container">
    ...
    <c:forEach items="${hotell}" var="q">
    
        <div class="col-md-4 ftco-animate">
          <div class="project-wrap">
          
        <a href="#" class="img"  style="background-image: url(data:image/jpg;base64);"> 
       <img src="data:image/jpg;base64,${q.getBase64Image()}" width="300" height="300" />${q.getImage_hotel()}
                <span class="price">$ ${q.getPrix_hotel()}/person</span>
    ...
    <div class="text p-4">
      ...
      ${q.getNom_hotel()}
      <c:choose>
    <c:when test="${q.getEtoile_hotel() =='1'}">
      <a href="#"></a>
      <br>
      <span class="fa fa-star"></span>
        <br />
    </c:when>  
    <c:when test="${q.getEtoile_hotel() =='2'}">
    <a href="#"></a>
     <br>
      <span class="fa fa-star"></span>
      <span class="fa fa-star"></span>
    ...
    <c:when test="${q.getEtoile_hotel() =='3'}">
    <a href="#"></a>
     <br>
      <span class="fa fa-star"></span>
      <span class="fa fa-star"></span>
    ...
    <c:when test="${q.getEtoile_hotel() =='4'}">
    <a href="#"></a>
     <br>
      <span class="fa fa-star"></span>
      <span class="fa fa-star"></span>
    ...
    <a href="#"></a>
     <br>
      ...
      <p class="location"><span class="fa fa-map-marker"></span> ${q.getVille()}</p>
      ${q.getInclusivite_hotel()}
