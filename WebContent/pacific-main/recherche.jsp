...
<section class="ftco-section">
   <div class="container">
    ...
    <c:forEach items="${voyages}" var="q">
       ...
       <img src="data:image/jpg;base64,${q.getBase64Image()}" width="300" height="300" />${q.getImage()}
                <span class="price">$ ${q.getPrix()}/person</span>
            </a>
            
           
            
            <div class="text p-4">
                <span class="days">${q.getDuree()} Days Tour</span>
                <h3 class="product-name">${q.getDestination()}</h3>
                
                
                <p class="location"><span class="fa fa-map-marker"></span> ${q.getDestination()}, ${q.getContinent()}</p>
               Depart le  ${q.getDate()}
                <ul>
                   
                   <li><span class="flaticon-mountains"></span>${q.getType()}</li>
                   <li>Voyage ${q.getTheme()}</li>
               </ul>
