    ...
    <div class="row">
       ...
       <div class="col-md-4 ftco-animate">
         ...
         <a href="#" class="img"  style="background-image: url(images/destination-1.jpg);"> 
                <span class="price">$ ${e.getVoyage_accParId(q.getId_Voyage_acc()).getPrix_acc()} /person</span>
            </a>
            <div class="text p-4">
                <span class="days">${e.getVoyage_accParId(q.getId_Voyage_acc()).getDuree_acc()} Days Tour</span>
                <h3 class="product-name">${e.getVoyage_accParId(q.getId_Voyage_acc()).getDestination_acc()}</h3>
                
                
                <p class="location"><span class="fa fa-map-marker"></span> ${e.getVoyage_accParId(q.getId_Voyage_acc()).getDestination_acc()}, ${e.getVoyage_accParId(q.getId_Voyage_acc()).getContinent_acc()}</p>
               Depart le  ${e.getVoyage_accParId(q.getId_Voyage_acc()).getDate_acc()}
                <ul>
                   <li><span class="flaticon-mountains"></span>${e.getVoyage_accParId(q.getId_Voyage_acc()).getTheme_acc()}</li>
               </ul>
           </div>
           <div class="product-btns"> 
                  <a href="supprimer_panierAcc.php?id_panier_acc=${ q.getId_panier_acc() }" >
                  <button class="add-to-compare"><i class="fa fa-trash"></i><span class="tooltipp">Supprimer du Panier</span></button></a>
                    </div>
