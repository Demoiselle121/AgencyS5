...
<div class="form-field">
<div class="icon"><span class="fa fa-search"></span></div>
<input type="text" class="form-control" name ="hotel" placeholder="Search place">
</div>
</div>
</div>
<div class="col-lg d-flex">
...
<div class="form-field">
<div class="icon"><span class="fa fa-calendar"></span></div>
<input type="text" name="date" class="form-control checkin_date" placeholder="Check In Date">
</div>
</div>
</div>
