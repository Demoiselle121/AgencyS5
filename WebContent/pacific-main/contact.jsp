...
<li class="nav-item"><a href="VoyageAcc.php" class="nav-link">Circuit accompagne</a></li>
    ...
    <div class="row block-9">
      <div class="col-md-6 order-md-last d-flex">
        <form action="contact.php"  method="POST" class="bg-light p-5 contact-form">
          ...
          <div class="form-group">
            <textarea name="textMessage" id="" cols="30" rows="7" class="form-control" name="message" placeholder="Message"></textarea>
          </div>
          <div class="form-group">
