               ...
               <div class="col-lg d-flex">
                  <div class="form-group p-4">
                     ...
                     <div class="form-field">
                       ...
                       <input type="text" name="dureeMin" class="form-control checkin_date" placeholder="Check In Date">
                   </div>
               </div>
           </div>
           <div class="col-lg d-flex">
              <div class="form-group p-4">
                 ...
                 <div class="form-field">
                   <div class="icon"><span class="fa fa-calendar"></span></div>
                   <input type="text" name="dureeMax" class="form-control checkout_date" placeholder="Check Out Date">
               </div>
           </div>
       </div>
       <div class="col-lg d-flex">
          <div class="form-group p-4">
             ...
             <div class="form-field">
               <div class="select-wrap">
                ...
                <select name="budge" id="" class="form-control">
       ...
       <div class="col-md-4 ftco-animate">
          <div class="project-wrap">
            ...
            <div class="text p-4">
                ...
                <h3 class="product-name"><a href="/pacific-main/voyage?id_c=9">ROME PREMIUM 4 VOYAGE LUXE</a></h3>
   ...
   <div class="col-md-4 ftco-animate">
      <div class="project-wrap">
        ...
        <div class="text p-4">
            ...
            <h3></h3><a href="/pacific-main/voyage?id_c=7">MALAISIE PREMIUM</a></h3>
            <p class="location"><span class="fa fa-map-marker"></span> Banaue, Ifugao, Philippines</p>
            <ul>
               <li><span class="flaticon-shower"></span>2</li>
               <li><span class="flaticon-king-size"></span>3</li>
