...
<section class="ftco-section">
   ...
   <div class="col-md-4 ftco-animate">
       ...
       <img src="data:image/jpg;base64,${v.getBase64Image()}" width="300" height="300" />${v.getImage_acc()} 
                <span class="price">$ ${v.getPrix_acc()}/person</span>
            </a>
   ...
   <div class="col-md-4 ftco-animate">
            ...
            <div class="text p-4">
                <span class="days">${v.getDuree_acc()} Days Tour</span>
                <h3 class="product-name">${v.getDestination_acc()}</h3>
                
                
                <p class="location"><span class="fa fa-map-marker"></span> ${v.getDestination_acc()}, ${v.getContinent_acc()}</p>
               Depart le  ${v.getDate_acc()}
               <div><span><strong>For just $ ${v.getPrix_acc()} per person  !</strong></span></div>
                <ul>
                   <li><span class="flaticon-mountains"></span>${v.getType_acc()}</li>
                  
                   <li><span class="flaticon-king-size"></span>${v.getHebergement_acc()}</li>
               </ul>
           
            <p class="location"><span class="fa fa-map-marker"></span> ${v.getActivite()} ${v.getGenre()} avec notre guide: ${v.getGuide()}</p>
             
       </div>
       </div>
       <div>
       <a href="panierAcc.php?id_VAcc=${ v.getId_Voyage_acc() }">
